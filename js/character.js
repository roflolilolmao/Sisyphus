...
class Character
{
    ...
    animate_step_left()
    {
        this.character.left_leg.rotation = BASE_RIGHT_LEG_ROTATION + time_to_next_beat / beat_duration() * LEG_AMPLITUDE
        this.character.right_leg.rotation = BASE_LEFT_LEG_ROTATION - time_to_next_beat / beat_duration() * LEG_AMPLITUDE
    }


    animate_step_right()
    {
        this.character.left_leg.rotation = BASE_LEFT_LEG_ROTATION - time_to_next_beat / beat_duration() * LEG_AMPLITUDE
        this.character.right_leg.rotation = BASE_RIGHT_LEG_ROTATION + time_to_next_beat / beat_duration() * LEG_AMPLITUDE
    }
    ...
    head_bobble()
    {
        ...
        this.character.head.rotation = BASE_HEAD_BOBBLE_RETARDNESS - Math.sin(Math.PI / beat_duration() * time_to_next_beat) * HEAD_BOBBLE_AMPLITUDE
